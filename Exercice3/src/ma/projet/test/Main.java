...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        mariageService.create(new Marriage(sdf.parse("15/10/2025"), null, 4, hommes[0], femmes[0]));
        mariageService.create(new Marriage(sdf.parse("15/10/2025"), null, 2, hommes[0], femmes[1]));
        mariageService.create(new Marriage(sdf.parse("15/10/2025"), null, 3, hommes[0], femmes[2]));

        mariageService.create(new Marriage(sdf.parse("15/10/2025"), null, 1, hommes[1], femmes[3]));
        mariageService.create(new Marriage(sdf.parse("15/10/2025"), null, 1, hommes[1], femmes[4]));
        mariageService.create(new Marriage(sdf.parse("15/10/2025"), null, 1, hommes[1], femmes[5]));
        mariageService.create(new Marriage(sdf.parse("15/10/2025"), null, 1, hommes[1], femmes[6]));
        ...
        List<ma.projet.classes.Femme> femmesPlusieursMariages = femmeService.getFemmesMarieesDeuxFoisOuPlus();
